...
@SequenceGenerator(name = "seq_especialidade", sequenceName = "especialidade_id_seq", allocationSize = 1, initialValue = 1)
public class Especialidade implements Serializable {
    ...
    public Especialidade(Integer id, String titulo, String slug, String icone, String detalhamento) {
        this.id = id;
        this.titulo = titulo;
        this.slug = slug;
        this.icone = icone;
    ...
    public String toString() {
        return "Especialidade {" + "id=" + id + ", titulo=" + titulo + ", slug=" + slug + ", icone=" + icone + ", detalhamento=" + detalhamento + ", empresaId=" + empresaId + '}';
    }
