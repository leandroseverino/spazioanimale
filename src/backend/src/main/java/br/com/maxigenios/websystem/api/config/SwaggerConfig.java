package br.com.maxigenios.websystem.api.config;
...
import br.com.maxigenios.websystem.api.util.JwtTokenUtil;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("br.com.maxigenios.websystem.api")).paths(PathSelectors.any()).build()
				.apiInfo(apiInfo());
	}
