...
public class EmpresaResourceTest {
	...
	@Test
	@WithMockUser
	public void testFindEmpresaWithInvalidCNPJ() throws Exception {
		BDDMockito
			.given(this.empresaService.findByCnpj(Mockito.anyString()))
	...
	@Test
	@WithMockUser
	public void testFindEmpresaWithValidCNPJ() throws Exception {
		BDDMockito
			.given(this.empresaService.findByCnpj(Mockito.anyString()))
			.willReturn(Optional.of(this.getEmpresa()));
